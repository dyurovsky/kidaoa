...
Surprisingly, responses from the oldest children in our sample more closely correlated with adult estimates of AoA [@kuperman2012] than did the judgments of adult participants in this study. This difference appears to be driven by older children being more likely to judge that a young child would *not* know later-acquired words. It is possible that children may be more accurate at estimating other children's lexical knowledge because of their proximity to the age that they learned a word [see also @walley1992]. Such an account should also predict that younger children would perform better than older children when making these inferences.<!--, which appears counter to our developmental findings.--> Given that the target words in our study are generally acquired by age 3 according to parent estimates [@frank2017], it is possible that younger children were more accurate in their judgments, in that they were more likely to judge that the target child knew a word. However, further work will need to be done to probe whether young children are indeed more accurate in their judgments of other children's word knowledge, or if other factors biased them to attribute knowledge to others. Our results thus suggest that older children are more sensitive to gradience in word knowledge, such that their confidence ratings closely recovered adult AoA estimates and parent-reported estimates. Another explanation for the difference between adults and children is that adults gave higher estimates for the target child's age than children did, and may have attributed more knowledge to the child as a result.

...
Of the 6 types of explanations, *Language* was used by the highest proportion of children (`r prop$language*100`%). *Unsure* and *Other* explanations contributed to just under half of all the explanations (`r prop$unsure*100`% and `r prop$other*100`% respectively). Of the remaining three types, children appealed to *Experience* the most (`r prop$experience*100`%), followed by *Location* (`r prop$location*100`%) and *Age* (`r prop$age*100`%; see Figure \ref{fig:explanations}). Note that because coding categories were not mutually exclusive, the proportions sum to greater than 1. To understand how children's explanations may change over development, we looked at explanations in each age group. Perhaps unsurprisingly, *Unsure* explanations were more common in younger children, accounting for over half (`r each_age$unsure[1]*100`%) of the 4-year-olds' explanations. 

Almost half of the 7- and 8-year-olds appealed to *Language* explanations (`r each_age$language[4]*100`% and `r each_age$language[5]*100`%). Surprisingly, 5-year-olds were also likely to use *Language* explanations (`r each_age$language[2]*100`%), while this type of explanation was rarely used by 4- and 6-year-olds.

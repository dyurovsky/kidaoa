...
Our primary analyses compare knowledge judgments on our 6-point scale to AoA judgments from adults [taken from @kuperman2012]. Data were analyzed using pre-registered mixed effects model using the \texttt{lme4} package in \texttt{R} [@bates2015]. We predicted children's judgments from adult AoA estimates, including random effects for participant and word.

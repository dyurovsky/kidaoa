...
```{r explanations,fig.env = "figure*", fig.cap = "Children's explanations for why they think Sam knew/didn't know an animal. Categories are not mutually exclusive."}
...
print(exp_plot, fig.align = "right", fig.pos="t", 
      environment = "figure*")

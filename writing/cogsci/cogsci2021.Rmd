...
Do children’s judgments about a child’s vocabulary knowledge reflect a sensitivity to which words are learned later? To answer this question, we compared children’s judgments on our 6-point scale to adult judgments from Kuperman et al. (2012). Data were analyzed using pre-registered mixed effects model predicting children’s judgments from adult AoA estimates (Kuperman et al., 2012), including random effects for participant and word. Using the lme4 package in R (**citation**), our model syntax was `judgment ~ aoa + (1 | participant) + (1|word)`.

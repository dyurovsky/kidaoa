...
6-point scale. Children's responses to these two items were recoded onto
a 1-6 scale from 1--\emph{very sure Sam doesn't know} to 6--\emph{very
sure Sam knows}.
...
To analyze children's responses on these familiarization items, we used
a mixed effects model using the \texttt{lme4} package in \texttt{R}
...
\textless{} .001). As a group, children judged that the target child
would be most likely to know an early-acquired word (e.g., \emph{dog})
and least likely to know a late-acquired word (e.g., \emph{lobster}, see
...
knowledge, but do they make accurate judgments about another person's
...
our developmental findings. Additionally, adults gave higher estimates
for the target child's age than children did, and may have attributed
more knowledge to the child as a result.
